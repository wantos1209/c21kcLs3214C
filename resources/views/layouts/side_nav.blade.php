...
<div class="sec_list_sidemenu">
    ...
    {{-- @canany(['member_list', 'seamless', 'history_transaction', 'referral', 'history_game', 'member_running-order',
        'report']) --}}
        <div class="nav_group">
            ...
            <div class="list_sidejsx">
                ...
                {{-- @can('history_transaction') --}}
                    <div class="data_sidejsx {{ Request::is('historytransaction*') ? 'active' : '' }}">
                        <a href="/historytransaction" id="Player">
                            ...
                            <span class="nav_title1">history transaction</span>
                        </a>
                    </div>
                {{-- @endcan --}}
                @can('referral')
                ...
                @endcan
                {{-- @can('member_running-order') --}}
                    <div class="data_sidejsx {{ Request::is('running-order*') ? 'active' : '' }}">
                        <a href="/running-order" id="Player">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                                <path fill="currentColor"
                            ...
                            <span class="nav_title1">running order</span>
                            <span class="countdatapend running-order">0</span>
                        </a>
                    </div>
                {{-- @endcan --}}
                ...
                @endcan
                {{-- @can('report') --}}
                    <div class="data_sidejsx {{ Request::is('report*') ? 'active' : '' }}">
                        <a href="/report" id="Player">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                ...
                {{-- @can('memo') --}}
                    <div class="data_sidejsx {{ Request::is('memods*') ? 'active' : '' }}">
                        <a href="/memods" id="Player">
                            ...
                            <span class="countdatapend memo">{{ 0 }}</span>
                        </a>
                    </div>
                {{-- @endcan --}}
            </div>
    ...
    {{-- @canany(['agent', 'analytic', 'content', 'apk_setting', 'memo_other', 'linkalternatif']) --}}
        <div class="nav_group">
            ...
            <div class="list_sidejsx">
                {{-- @can('agent') --}}
                    <div class="data_sidejsx {{ Request::is('agent*') ? 'active' : '' }}">
                        <a href="/agent" id="Player">
                ...
                @endcan
                {{-- @can('apk_setting') --}}
                    <div class="data_sidejsx {{ Request::is('gamesetting*') ? 'active' : '' }}">
                        <a href="/gamesetting" id="Player">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                                <path fill="currentColor"
                                    d="m9.25 22l-.4-3.2q-.325-.125-.612-.3t-.563-.375L4.7 19.375l-2.75-4.75l2.575-1.95Q4.5 12.5 4.5 12.338v-.675q0-.163.025-.338L1.95 9.375l2.75-4.75l2.975 1.25q.275-.2.575-.375t.6-.3l.4-3.2h5.5l.4 3.2q.325.125.613.3t.562.375l2.975-1.25l2.75 4.75l-2.575 1.95q.025.175.025.338v.674q0 .163-.05.338l2.575 1.95l-2.75 4.75l-2.95-1.25q-.275.2-.575.375t-.6.3l-.4 3.2zm2.8-6.5q1.45 0 2.475-1.025T15.55 12t-1.025-2.475T12.05 8.5q-1.475 0-2.488 1.025T8.55 12t1.013 2.475T12.05 15.5" />
                            </svg>
                            <span class="nav_title1">Game setting</span>
                        </a>
                    </div>
                {{-- @endcan --}}
                @can('linkalternatif')
