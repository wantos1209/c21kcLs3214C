            ...
            <div class="groupsecagentds">
                <div class="headgroupsecagentds">
                    ...
                    <div class="listheadsecagentds bottom">
                        ...
                        <form action="/agent" method="GET" class="groupsearchagentds">
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $i => $d)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="splitcollum" title="suka ngibul">
                                                <span class="userpending">
                                                    {{ $d->username }}
                                                    {{-- <a href="/agent/agentinfo" class="iconprofile openviewportinfo"
                                                        target="_blank">
                                        ...
                                        <td>{{ $d->divisi }}</td>
                                        <td class="statusagent" data-status="{{ $d->status == 'active' ? 1 : 3 }}"></td>
                                        <td>
                                            <div class="grouptools">
                                                <a href="/agent/agentupdate/{{ $d->id }}" target="_blank"
